...
export const SearchResults = React.memo(function SearchResults(props: SearchSelectorProps) {
  return (
    <div
      className="absolute left-1/2 -translate-x-1/2 sm:left-4 sm:translate-x-0 md:left-10 top-[190px] sm:top-[210px] z-10 w-[94vw] sm:w-[400px] mt-1 bg-white border border-gray-200 rounded-xl shadow-2xl overflow-y-auto max-h-80"
    >
